...
def process_video(
    ...
    *,
    ...
    """Execute reusable stages, optionally checkpointed by a durable runner.

    All filesystem, model, and media work is inside the stage callbacks. The
    ...
    def source():
        ...
        return file_fingerprint(video)

    fingerprint = execute("source", source)
    def read_probe():
    ...
    def make_assets():
        ...
        assets_params = {
            ...
            "motion": [step.get("motion") for step in lesson["steps"]],
            "transcript": digest_json(segments),
    ...
    lesson = execute("frames", make_assets)
    ...
    return execute("assemble", assemble)
